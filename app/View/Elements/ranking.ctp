				...
				<table class="table">
						...
						<?php foreach($rankedUsers as $rank => $rankedUser): ?>
							<tr>
								...
								<td><?php echo number_format($rankedUser['ExpectationResult']['price']); ?>円
								<!--<br><?php echo $rankedUser['ExpectationResult']['win'] ?>勝<?php echo $rankedUser['ExpectationResult']['lose'] ?>敗--></td>
							</tr>
						<?php endforeach; ?>
				</table>
			</div>
