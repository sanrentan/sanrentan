...
<div id="mypage">
	...
	<div id="resultArea">
		<div id="imgArea">
			<img src="/img/common/kojikabe.jpg" class="img1">
			<img src="/img/common/keiba_sozai2.jpg" class="img2">
		</div>
		<br>
		...
		<table border="1" class="pc">
			<tr><th>No.</th><th width="80">日付</th><th>レース名</th><th width="180">結果<br>１着/２着/３着</th><th width="100">配当金</th><th width="130">こじはる予想</th><th>結果</th></tr>
