...
<div class="userForm">
	<?php echo $this->Form->create('Race'); ?>
	    <fieldset>
			...
			<?php echo $this->Form->input('placeArray',array("label"=>"競馬場","selected"=>$this->data["Race"]["placeArray"]));?>
			<?php echo $this->Form->input('raceArray',array("label"=>"第何レース","selected"=>$this->data["Race"]["raceArray"]));?>
